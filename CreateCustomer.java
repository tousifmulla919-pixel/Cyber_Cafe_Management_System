...
ps1=conn.prepareStatement("insert into customer values (default,?,?,?,?,?,?,?,(select to_date(?,'DD MM YYYY')))");
...
if(ae.getSource()==b1)
{
if(t1.getText().equals("") || t2.getText().equals("")  || t3.getText().equals("")  || t4.getText().equals("")  || t5.getText().equals("")  || t6.getText().equals("")  || t8.getText().equals("") )
